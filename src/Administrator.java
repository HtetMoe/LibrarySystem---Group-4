...
public class Administrator extends Role implements Serializable {
    ...
    public static boolean addNewBook(String ISBN,String title,
        ...
        Book book = Book.createBookWithAuthor(ISBN,title,firstName,lastName,phone,street,city,state,zip,credential,bio,
                copies,borrowDuration);
        return DataAccessFacade.getInstance().addBook(ISBN,book);

    }


    public static boolean addMember(String id,String password,String firstName,String lastName, String phone,
                                String street,String city,String state, String zip,
                                AuthorizationLevel level){
        Person person = Person.createMember(id,password,firstName,lastName,phone,street,city,state,zip,level);
